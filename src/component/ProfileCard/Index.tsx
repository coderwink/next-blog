...
export default function Index() {
  ...
  return (
    <div className='box-border px-10 bg-white rounded-3xl  relative -top-14 flex flex-col divide-y divide-slate-200 lg:flex-row lg:divide-x lg:divide-y-0 lg:py-10'>
      {/* 头像部分 */}
      <div className='flex flex-col items-center -mt-20 lg:flex-1 lg:px-2 lg:flex-row lg:mt-0'>
